    ...
    $(window).on('scroll', function () {
        ...
        $(window).resize(function () {
            if (window.innerWidth <= 820) {
                var width450vw = parseInt($(window).width()*0.83);
                //console.log(width450vw+"vw");
                if (scrollTop >= width450vw) {
                    $('.title_box').addClass('scroll');
                } else {
                    $('.title_box').removeClass('scroll');
                }
            } else {
                var width450vw = parseInt($(window).width()*0.35);
                //console.log(width450vw+"vw");
                if (scrollTop >= width450vw) {
                    $('.title_box').addClass('scroll');
                } else {
